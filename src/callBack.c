...
#define KEY_TEMPERATURE_HI 2
#define KEY_TEMPERATURE_LO 3  
#define KEY_TEMP_UNITS 4  //0 is F
#define KEY_INVERT_UI 5
#define KEY_IS_GPS 7
#define KEY_LATITUDE 8 
#define KEY_LONGITUDE 9 
#define KEY_ZIP_CODE 10
#define KEY_WEATHER_MESSAGE 11
#define KEY_PERSISTANT_MESSAGE 12
#define KEY_VERSION 13  
#define KEY_JS_READY 14 
...
void CallBack_sendPersistantMessage(void){
    ...
    dict_write_cstring(iter, KEY_ZIP_CODE, sZipCode);
...
void CallBack_refreshPersistance(void)
  ...
  if (persist_exists(KEY_ZIP_CODE))
    {
      persist_read_string((KEY_ZIP_CODE),sZipCode,sizeof(sZipCode));
  }
  else
    {
...
static void inbox_received_callback(DictionaryIterator *iterator, void *context) {
  ...
  while(t != NULL) {
    ...
    case KEY_TEMPERATURE_HI:
      temperature_hi = (int)t->value->int32;
			//APP_LOG(APP_LOG_LEVEL_INFO, "temperature_hi -callback- %i",temperature_hi);
      break;
      
    case KEY_TEMPERATURE_LO:
      temperature_lo = (int)t->value->int32;
      break;
